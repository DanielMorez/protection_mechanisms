"""
Django settings for protection_mechanisms project.
...
SECRET_KEY = 'django-insecure-ot5jh66%z$eg$bzs4!99asdxy_s%rniq5vex1gsymbbmd!i8#q'
...
ROOT_URLCONF = 'protection_mechanisms.urls'
...
WSGI_APPLICATION = 'protection_mechanisms.wsgi.application'
